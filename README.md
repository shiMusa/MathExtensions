...
Complex and reals numbers, vectors, matrices interpoerate automatically (in most cases).
...
- complex vector: CVector64; real vector with subset of these functions
    - operators [], ==, +, -, *, /
    ...
    - angle
- complex matrix: CMatrix64; real matrix with subset of these functions
    - operators [], [][], ==, +, -, *, /
    - multiple initialization functions
